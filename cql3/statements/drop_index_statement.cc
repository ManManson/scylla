...
drop_index_statement::drop_index_statement(const index_name& index_name, bool if_exists)
    : schema_altering_statement{std::move(index_name.get_cf_name()), &timeout_config::truncate_timeout}
