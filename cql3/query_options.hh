...
private:
    ...
    mutable std::unordered_map<uint8_t, bytes_opt> _cached_fn_calls;
private:
    /**
...
public:
    ...
    void cache_function_call(uint8_t id, bytes_opt value) const;
    const std::unordered_map<uint8_t, bytes_opt>& cached_function_calls() const;
    std::unordered_map<uint8_t, bytes_opt>&& take_cached_function_calls();
    void set_cached_function_calls(std::unordered_map<uint8_t, bytes_opt> vals);
