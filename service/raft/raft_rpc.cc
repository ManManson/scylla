...
future<> raft_rpc::add_server(raft::server_id id, raft::server_info info, bool expiring) {
    ...
    return _raft_services.update_address_mapping(id, ser::deserialize(in, boost::type<gms::inet_address>()), expiring);
}
